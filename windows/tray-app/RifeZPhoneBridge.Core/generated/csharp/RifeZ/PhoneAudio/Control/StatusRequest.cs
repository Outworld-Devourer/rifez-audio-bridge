...
public struct StatusRequest : IFlatbufferObject
{
  ...
  public static void StartStatusRequest(FlatBufferBuilder builder) { builder.StartTable(0); }
  public static Offset<RifeZ.PhoneAudio.Control.StatusRequest> EndStatusRequest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RifeZ.PhoneAudio.Control.StatusRequest>(o);
  }
}
